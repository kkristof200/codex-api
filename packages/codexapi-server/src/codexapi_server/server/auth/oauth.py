...
from .constants import OAUTH_ISSUER_DEFAULT
...
<html lang=\"en\">
  ...
  <body>
    <div style=\"max-width: 640px; margin: 80px auto; font-family: system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial, sans-serif;\">
      ...
      <p>You can now close this window and return to the terminal and run <code>codexapi serve</code> to start the server.</p>
    </div>
  </body>
  </html>
"""
